...
template<typename T>
bool is_primen(T x){
  return is_prime_64n(x);
}

template<typename T>
bool is_primei(T x){
  return is_prime_64i(x);
}

template<typename T>
bool is_sprpn(T x, T y){
  return is_sprp_64n(x,y);
}

template<typename T>
bool is_sprpi(T x, T y){
  return is_sprp_64i(x,y);
}
...
template<typename T>
bool prime_genn(uint8_t x, T *res){
  return prime_gen_64n(x, res);
}

template<typename T>
bool prime_geni(uint8_t x, T *res){
  return prime_gen_64i(x, res);
}
